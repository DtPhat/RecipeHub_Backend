		...
		return new CommandLineRunner() {
			...
			public void run(String... args) throws Exception {
				...
				supportTicketRepository.save(
						new SupportTicket(null, "trinhvinhphat123@gmail.com", "hello", SupportTicketStatus.PENDING));
				supportTicketRepository
						.save(new SupportTicket(null, "hello123@gmail.com", "hello", SupportTicketStatus.PENDING));
				supportTicketRepository.save(
						new SupportTicket(null, "eololo123@gmail.com", "hihihihihi", SupportTicketStatus.PENDING));

				// create user
				userRepository.save(new User("admin@gmail.com", getPasswordEncoder().encode("123456"), Role.ADMIN,
						"admin", Gender.MALE, true, DateTimeUtil.milisecondToDate(System.currentTimeMillis()),
						avartarBaseUrl + "default.jpg", LoginType.BASIC, false));
				userRepository.save(new User("user@gmail.com", getPasswordEncoder().encode("123456"), Role.USER, "user",
						Gender.MALE, true, DateTimeUtil.milisecondToDate(System.currentTimeMillis()),
						avartarBaseUrl + "default.jpg", LoginType.BASIC, false));
				userRepository.save(new User("user1@gmail.com", getPasswordEncoder().encode("123456"), Role.USER,
						"user1", Gender.FEMALE, true, DateTimeUtil.milisecondToDate(System.currentTimeMillis()),
						avartarBaseUrl + "default.jpg", LoginType.BASIC, false));
				userRepository.save(new User("user2@gmail.com", getPasswordEncoder().encode("123456"), Role.USER,
						"user2", Gender.FEMALE, true, DateTimeUtil.milisecondToDate(System.currentTimeMillis()),
						avartarBaseUrl + "default.jpg", LoginType.BASIC, false));
				userRepository.save(new User("danevil2003@gmail.com", getPasswordEncoder().encode("123456"), Role.ADMIN,
						"Phat", Gender.FEMALE, true, DateTimeUtil.milisecondToDate(System.currentTimeMillis()),
						avartarBaseUrl + "default.jpg", LoginType.BASIC, false));
